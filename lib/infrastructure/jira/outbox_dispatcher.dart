...
class OutboxDispatcher {
  ...
  bool _isRetryable(Failure failure) => switch (failure) {
    ...
    // None of the AI, transcription or recording failures can reach the Jira
    // queue — no operation kind calls an engine or a microphone. They are
    // listed rather than swept up by a wildcard so that the next failure added
    // to the domain still has to be classified here instead of silently
