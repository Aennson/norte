...
5. The current sprint file in `docs/sprints/` — execute sprints strictly in order (00 → 10; 00–08 deliver v1.0, 09 opens v1.1, 10 is last of all and instruments what every other sprint built).
